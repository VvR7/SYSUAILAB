...
class MLP:
    def __init__(self, input_dim, hidden_dim1, hidden_dim2, hidden_dim3, output_dim, lr=0.01):
        ...
        # He 初始化
        self.w1 = np.random.randn(input_dim, hidden_dim1) * np.sqrt(2 / input_dim)
        self.b1 = np.zeros(hidden_dim1)
        self.w2 = np.random.randn(hidden_dim1, hidden_dim2) * np.sqrt(2 / hidden_dim1)
        self.b2 = np.zeros(hidden_dim2)
        self.w3 = np.random.randn(hidden_dim2, hidden_dim3) * np.sqrt(2 / hidden_dim2)
        self.b3 = np.zeros(hidden_dim3)
        self.w4 = np.random.randn(hidden_dim3, output_dim) * np.sqrt(2 / hidden_dim3)
    ...
    def train(self,x_train,y_train,x_val,y_val,epochs,lr,batch_size=32,discount_rate=0.999,constrant=1e-5):
        self.lr=lr
        min_lr=1e-7
...
model=MLP(input_dim=2,hidden_dim1=64,hidden_dim2=32,hidden_dim3=16,output_dim=1)
model.train(x_train,y_train,x_val,y_val,epochs=10000,lr=5e-3,batch_size=64)
